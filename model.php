...
$ctable_modal = "modal";
$ctable_brand = "brand";
$ctable_brand_where = "id='" . $_REQUEST["brand_id"] . "' AND isDelete=0";
$ctable_brand_r = $db->rp_getData($ctable_brand, "*", $ctable_brand_where);
$ctable_brand_d = mysqli_fetch_array($ctable_brand_r);
$item_per_page =  ($_REQUEST["show"] <> "" && is_numeric($_REQUEST["show"])) ? intval($_REQUEST["show"]) : 6;
...
$ctable_where1 = "brand_id='" . $_REQUEST["brand_id"] . "' AND isDelete=0";
$get_total_rows = $db->rp_getTotalRecord($ctable_modal, $ctable_where1); //hold total records in variable

$total_pages = ceil($get_total_rows / $item_per_page);
$page_position = (($page_number - 1) * $item_per_page);

$ctable_modal_where = "brand_id='" . $_REQUEST["brand_id"] . "' AND isDelete=0";
$ctable_modal_r = $db->rp_getData($ctable_modal, "*", $ctable_modal_where, "id ASC limit $page_position, $item_per_page", 0);
...
<body class="archive tax-device-category term-iphone term-111 theme-tekhfixers woocommerce-no-js hfeed visual-composer wpb-js-composer js-comp-ver-6.8.0 vc_responsive">
                    ...
                    <div class="container">
                        <div class="page-title-inner">
                            <div class="page-title-content clearfix">
                                <!-- <h1 class="page-title ft-heading-b">Device Modal:
                                    <span><?php echo $ctable_brand_d["brand_name"] ?></span>
                                </h1> -->
                                <div class="row">
                ...
                <div class="container content-container">
                    ...
                    <div id="primary">
                        <main id="main" class="site-main row">
                            <!-- <div class=" col-lg-6 col-md-6 col-sm-6 col-12">
                                <h3>Select Your <?php echo $ctable_brand_d["brand_name"] ?></h3>
                            </div> -->
                            <div class="repair-item col-lg-12 col-md-12 col-sm-12 col-12">
                                <section class="no-results not-found no-results-1 ">
                                    <div class="page-content">
                                        <form role="search" action="" method="post" class="search-form">
                                            <div class="searchform-wrap">
                                                <input type="text" placeholder="Search Keywords..." name="search" class="search-field" value="<?php if (isset($_POST['search'])) {
                                                                                                                                                    echo $_POST['search'];
                                                                                                                                                } ?>" />
                    ...
                    <div id="primary">
                        <main id="main" class="site-main row">
                            <?PHP
                            if ($_POST['search'] == '') {
                                if (mysqli_num_rows($ctable_modal_r) > 0) {
                                    while ($ctable_modal_d = mysqli_fetch_array($ctable_modal_r)) {
                            ?>
                                        <div class="repair-item col-lg-4 col-md-3 col-sm-6 col-12">
                                            <div class="image-item">
                                                <a href="select-problem.php?category_id=<?php echo $ctable_modal_d['category_id'] ?>&brand_id=<?php echo $_REQUEST['brand_id'] ?>&modal_id=<?php echo $ctable_modal_d['id'] ?>">
                                                    <img src="<?php echo MODAL_IMAGE_SITE_A . $ctable_modal_d['image_path']; ?>" alt="<?php echo stripslashes($ctable_modal_d['modal_name']); ?>">
                                                </a>
                                            </div>
                                            <h3>
                                                <a href="select-problem.php?category_id=<?php echo $ctable_modal_d['category_id'] ?>&brand_id=<?php echo $_REQUEST['brand_id'] ?>&modal_id=<?php echo $ctable_modal_d['id'] ?>">
                                                    <?php echo stripslashes($ctable_modal_d['modal_name']); ?>
                                                </a>
                                            </h3>
                                        </div>
                                    <?php
                                    ...
                                    echo "<h2>No Modal Available</h2>";
                                }
                            } else {
                                $serach = $_POST['search'];
                                $ctable_modal_where = "brand_id='" . $_REQUEST["brand_id"] . "' AND modal_name LIKE '%$serach%' AND isDelete=0";
                        ...
                        <nav class="navigation posts-pagination">
                            <div class="posts-page-links">
                                <?php
                                echo $db->rp_web_paginate_function($item_per_page, $page_number, $get_total_rows, $total_pages, $_REQUEST["category_id"], $_REQUEST["brand_id"]);
                                ?>
                            </div>
                        </nav>
                    </div><!-- #primary -->
