...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($phone != "" && $password != "" && !filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
        ...
        if ($check_dup_user_t > 0) {
            ...
            $db->rp_location(SITEURL . "login.php");
        } else {
            ...
            $uid = $db->rp_insert("user", $values, $rows);
            if ($uid) {
                $db->flash("msg", "Congratulations, your account has been successfully created.");
                $db->rp_location(SITEURL . "login.php");
            } else {
                $db->flash("msg-error", "Not register");
                $db->rp_location(SITEURL . "register.php");
            }
        }
    } else {
        $db->flash("msg-error", "Please enter correct email and password.");
        $db->rp_location(SITEURL . "register.php");
    }
}
...
<head>
    ...
    <title>Register &#8211; Tri-fixing &#8211; Mobile Device and Electronics Repair </title>
    <style type="text/css">
        @font-face {
            font-family: "Lato";
            font-style: normal;
...
<body class="page-template-default page page-id-557 theme-tekhfixers woocommerce-account woocommerce-page woocommerce-no-js visual-composer wpb-js-composer js-comp-ver-6.8.0 vc_responsive">
                                        ...
                                        <div class="woocommerce">
                                            ...
                                            <div class="u-columns col2-set" id="customer_login">
                                                ...
                                                <div class="u-column1 col-1">
                                                    <img width="604" height="737" src="images/iPhone-X.png" class="vc_single_image-img attachment-full" alt="" decoding="async" loading="lazy" title="iPhone X" srcset="images/iPhone-X.png 604w,images/iPhone-X.png 600w" sizes="(max-width: 604px) 100vw, 604px" />
                                                </div>
                                                <div class="u-column2 col-2">
                                                    <h2>Register</h2>
                                                    <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" role="form" id="target" method="post">
                                                            <div class="form-group">
                                                                <label for="register-email-2">Full Name *</label>
                                                                <input type="text" id="user_name" name="user_name" placeholder="Your name here.." class="form-control">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="tel" maxlength="10" id="phone" name="phone" placeholder="Mobile Number" class="form-control" />
                                                            ...
                                                            <p class="woocommerce-LostPassword lost_password"><span style="color: #b3c0d0;">I have an account </span><a href="login.php" style="color: #03255a;">Login account</a>
                                                            </p>
                                                        </form>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        function addRefferal() {
            ...
            $("#passwordError").html('');
            if (user_name == "") {
                $("#user_nameError").html('Please Enter your user name');
                $("#user_name").focus();
                return false;
            } else if (email == '') {
                ...
                $("#passwordError").html('passwords require one of the letters or digitys');
                $("#password").focus();
                return false;
            } else {
                $("#target").submit();
