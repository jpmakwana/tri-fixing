...
<head>
    ...
    <title>Home ButtonRepair &#8211; Tri-fixing &#8211; Mobile Device and Electronics Repair </title>
    ...
    <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed4629.json?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2Fhome-buttonrepair%2F" />
    <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed356e?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2Fhome-buttonrepair%2F&amp;format=xml" />
                    ...
                    <div class="container">
                        <div class="page-title-inner">
                            <div class="page-title-content clearfix"> <a href="category.php" class="back-link">Back to Services</a>
                                <h1 class="page-title ft-heading-b"><span>Home Button</span>Repair</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div id="collapse-fr-service-menu4" class="collapse  " aria-labelledby="heading-4" data-parent="#fr-service-menu">
                                                                            <div class="card-body">
                                                                                <ul class="list-menu-service">
                                                                                    <li class="active"><a href="index.php"> <i class="zmdi zmdi-chevron-right"></i> <span>Home Button</span>Repair </a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div id="cms-heading" class="cms-heading  align-left align-left-md align-left-sm align-left-xs ">
                                                            <h3 class="cms-heading-tag     " style="margin-bottom:20px;color:#083260;font-size:54px;letter-spacing:-.016em;text-transform:none;font-weight:400;font-style:normal;display:inline-block; "> Home Button Repair</h3>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>Devices with home buttons on the front of the device are becoming quite ancient now, due to the rise of full display devices. But this doesn&#8217;t mean existing devices with home buttons are immune from failing.</p>
                                                            </div>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>At TekhFixers we can diagnose and repair a faulty home button on any device. In most cases the back of the button can become detached from the mainboard and results in a non functioning home button. Non-genuine battery replacements can also cause the home button in certain devices to stop working.</p>
                                                            </div>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>If you&#8217;re experiencing a faulty home button and you have had the battery replaced then we can replace the battery with a genuine part at a discount. Please get in touch if this is the case.</p>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="vc_column-inner vc_custom_1541521972917">
                                                                    <div class="wpb_wrapper">
                                                                        <div id="cms-heading-2" class="cms-heading  align-left align-left-md align-left-sm align-left-xs ">
                                                                            ...
                                                                            <p class="cms-heading-desc" style="color:#032549;line-height:1.8;font-weight:500;"> Our repairs and replacement parts will last the life of the phone. We only use genuine parts in our repairs. All our repairs come with a 12 month warranty.</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="vc_column-inner vc_custom_1541522086706">
                                                                    <div class="wpb_wrapper">
                                                                        <div id="cms-heading-3" class="cms-heading  align-left align-left-md align-left-sm align-left-xs ">
                                                                            ...
                                                                            <p class="cms-heading-desc" style="color:#032549;line-height:1.8;font-weight:500;"> A 12 months warranty comes with all our repairs unless states otherwise. If the repair in the device fails, we will fix it at no cost to you. We'll give you a free shipping label to get it back to us.</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<!-- Mirrored from demo.cmssuperheroes.com/themeforest/wp-tekhfixers/services/home-buttonrepair/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 06:40:40 GMT -->
