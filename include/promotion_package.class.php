...
class PromotionPackage extends Functions
{
	public $db;
	public $log;
	public $ctable="promotion_package";
	...
	public function InsertPackage($detail) 
	{
		extract($detail);
	 ...
	 public function UpdatePackage($detail)
	  {
			extract($detail);
	...
	public function EditPackage($detail)
	{		
	...
	public function DeletePackage($detail)
	{
