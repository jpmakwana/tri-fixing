...
class Volunteer extends Functions
{
	public $db, $log;
	public $ctable="volunteer";
	...
	public function DeleteVolunteer($detail)
	{
		$rows 	= array(
		"isDelete"	=> "1"
		);
			...
			$this->log->insertLog($this->ctable,$_REQUEST['id'],"delete","Volunteer deleted By User");
			if($eid!=0)
			{
				$reply=array("ack"=>1,"developer_msg"=>"deleted data.","ack_msg"=>"Success! Volunteer Delete Successfully.");
				return $reply;
			}
			else
			{
				$reply=array("ack"=>0,"developer_msg"=>"Database error!!","ack_msg"=>"Failed! Volunteer Delete Failed.");
				return $reply;
			}
	}
