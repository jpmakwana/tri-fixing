                                            ...
                                            <div class="col-xl-8 col-lg-8 col-md-12">
                                                <div class="choose-service-repair"> <input type="hidden" name="device" id="device" value="1526">
                                                    <div class="box mb-40 addition">
                                                        ...
                                                        <div class="body active not-clickable">
                                                            <ul class="list-options list-extras">
                                                                <?PHP
                                                                $ctable = "user_device_problem";
                                                                $ctable_cat_where = "order_id='" . $_REQUEST["order_id"] . "' AND isDelete=0";
                                                                ...
                                                                if (mysqli_num_rows($ctable_r) > 0) {
                                                                    if ($ctable_r) {
                                                                        while ($ctable_d = mysqli_fetch_array($ctable_r)) { ?>
                                                                            <li>
                                                                                <?php
                                                                                $ctable_p_problem_r = $db->rp_getData('device_problem', "*", "id='" . $ctable_d['device_probem_id'] . "' AND isDelete=0");
                                                                                $ctable_p_problem_d = mysqli_fetch_assoc($ctable_p_problem_r);
                                                                                $s_d_p_r = $db->rp_getData("sub_device_problem", "*", "id='" . $ctable_d['sub_device_problem_id'] . "' AND isDelete=0");
                                                                                $s_d_p_d = mysqli_fetch_assoc($s_d_p_r);
                                                                                $p_t_r = $db->rp_getData("device_problem_type", "*", "id='" . $s_d_p_d['device_problem_type_id'] . "' AND isDelete=0");
                                                                                $p_t_d = mysqli_fetch_assoc($p_t_r);
                                                                                ?>
                                                                                <div class="select-item">
                                                                                    <input type="checkbox" checked>
                                                                                    <label for="<?php echo stripslashes($ctable_p_problem_d['id']); ?>">
                                                                                        <span id="round"></span><?php echo stripslashes($ctable_p_problem_d['device_problem_name']); ?>
                                                                                    </label>
                                                                                    <span> <i class="fa fa-inr" aria-hidden="true"> </i>
                                                                                        <span id="amount<?php echo stripslashes($s_d_p_d['id']); ?>"><?php echo stripslashes($s_d_p_d['amount']); ?></span>
                                                                                        <sup></sup>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="sub-radio-buttons" style="display: block;">
                                                                                    <label class="select-item-type">
                                                                                        <input type="radio" id="<?php echo stripslashes($ctable_p_problem_d['id']); ?>"> <?php echo stripslashes($p_t_d['device_problem_type_name']); ?> </label>
