...
<head>
    ...
    <title>BatteryReplace &#8211; Tri-fixing &#8211; Mobile Device and Electronics Repair </title>
    ...
    <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed94cc.json?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2Fbatteryreplacement%2F" />
    <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed64bd?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2Fbatteryreplacement%2F&amp;format=xml" />
                    ...
                    <div class="container">
                        <div class="page-title-inner">
                            <div class="page-title-content clearfix"> <a href="category.php" class="back-link">Back to Services</a>
                                <h1 class="page-title ft-heading-b"><span>Battery</span>Replace</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                                                        ...
                                                                        <div id="collapse-fr-service-menu9" class="collapse  " aria-labelledby="heading-9" data-parent="#fr-service-menu">
                                                                            <div class="card-body">
                                                                                <ul class="list-menu-service">
                                                                                    ...
                                                                                    <li class="active"><a href="index.php"> <i class="zmdi zmdi-chevron-right"></i> <span>Battery</span>Replace </a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div id="cms-heading" class="cms-heading  align-left align-left-md align-left-sm align-left-xs ">
                                                            <h3 class="cms-heading-tag     " style="margin-bottom:20px;color:#083260;font-size:54px;letter-spacing:-.016em;text-transform:none;font-weight:400;font-style:normal;display:inline-block; "> Battery Replacement</h3>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>The most common issues with mobile devices older than 3 / 4 years is down to the battery. Naturally batteries degrade over time and this impacts your mobiles performance drastically.</p>
                                                            </div>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>We never repair a faulty battery due to the hazardous nature of the lithium-ion. We fully replace the battery with a factory replacement to ensure the longevity of the device and to return to its peak performance.</p>
                                                            </div>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>Our battery replacement service offers the quickest turnaround, we can repair your device and return it to you the very next day for free!</p>
                                                            </div>
                                                        </div>
