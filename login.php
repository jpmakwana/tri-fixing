...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_user_r = $db->rp_getData("user", "id", "email = '" . $phone_email . "' Or phone = '" . $phone_email . "' AND  password = '" . md5($password) . "' AND isDelete=0");
    if (mysqli_num_rows($check_user_r) > 0) {
        $check_user_d = mysqli_fetch_array($check_user_r);
        $uid =  $check_user_d['id'];
        $_SESSION['USER_ID'] = $uid;
        // $db->flash("msg", "You are successfully logged in");
        // $db->rp_location(SITEURL);
        // Redirect the user to the last open URL (or a default URL)
        if (isset($_SESSION['last_open_url'])) {
            $db->flash("msg", "You are successfully logged in");
            $db->rp_location($_SESSION['last_open_url']);
        } else {
            $db->flash("msg", "You are successfully logged in");
            $db->rp_location(SITEURL);
        }
    } else {
        $db->flash("msg-error", "Email or Password is incorrect.");
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Login &#8211; Tri-fixing &#8211; Mobile Device and Electronics Repair </title>
    <style type="text/css">
        @font-face {
            font-family: "Lato";
            font-style: normal;
...
<body class="page-template-default page page-id-557 theme-tekhfixers woocommerce-account woocommerce-page woocommerce-no-js visual-composer wpb-js-composer js-comp-ver-6.8.0 vc_responsive">
                                        ...
                                        <div class="woocommerce">
                                            ...
                                            <div class="u-columns col2-set" id="customer_login">
                                                ...
                                                <div class="u-column1 col-1">
                                                    ...
                                                    <img width="604" height="737" src="images/iPhone-X.png" class="vc_single_image-img attachment-full" alt="" decoding="async" loading="lazy" title="iPhone X" srcset="images/iPhone-X.png 604w,images/iPhone-X.png 600w" sizes="(max-width: 604px) 100vw, 604px" style="max-width: 70%;" />
                                                </div>
                                                ...
                                                <div class="u-column2 col-2">
                                                    ...
                                                    <div class="tab-pane fade  show active" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                                                        <div id="login_class">
                                                            <form role="form" id="target" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" autocomplete="off">
                                                                <div class="form-group">

                                                                    <label for="phone_email">Mobile Number Or Email *</label>
                                                                    <input type="text" placeholder="Number Or Email" name="phone_email" id="phone_email" required class="form-control" autocomplete="off">
                                                                    <p id="phone_emailError" class="error"></p>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <p class="form-row">
                                                                    <button type="submit" class="btn btn-outline-primary-2" onclick="return addRefferal()">
                                                                        <span>LOG IN</span>
                                                                        <i class="icon-long-arrow-right"></i>
                                                                    </button>
                                                                    <a href="forget-password.php" class="px-4" style="color: #03255a;"> Forget Password ?</a>
                                                                </p>
                                                                <p class="woocommerce-LostPassword lost_password"><span style="color: #b3c0d0;">Don't have an account ?</span><a href="register.php" style="color: #03255a;"> Create free account</a>
                                                                </p>
                                                                <p class="woocommerce-LostPassword lost_password"><span style="color: #b3c0d0;">Are you a vendor ?</span><a href="vendor/login.php" style="color: #03255a;"> Vendor Login</a>
                                                                </p>
    ...
    <script type="text/javascript">
        function addRefferal() {
            ...
            $("#phone_emailError").html('');
            $("#passwordError").html('');
            if (phone_email == "") {
                $("#phone_emailError").html('Please Enter your phone number or email');
                $("#phone_email").focus();
                return false;
            } else if (password == '') {
