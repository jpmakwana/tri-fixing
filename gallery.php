...
<head>
    ...
    <title>Gallery &#8211; Tri-fixing &#8211; Mobile Device and Electronics Repair </title>
    ...
    <div id="page" class="site">
                    ...
                    <div class="container">
                        <div class="page-title-inner">
                            <div class="page-title-content clearfix">
                                <h1 class="page-title ft-heading-b">Gallery</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="content" class="site-content">
            <div class="content-inner"> <svg style="fill: #B8F6DB; top:0px;" id="svg-top" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="195.875" height="1318.28" viewBox="0 0 195.875 1318.28">
                ...
                </svg> <svg style="top:1000px;bottom:0px" id="svg-bottom" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="446.28" height="1030.78" viewBox="0 0 446.28 1030.78">
                    <defs>
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div id="fr-gallery-grid" class="fr-gallery-grid default images-light-box  ">
                                                            <div class="row mt-5 gallery-filter">
                                                                <?php
                                                                ...
                                                                ?>
                                                                            <div class="grid-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mobile-repairs"> <a class="light-box" href="<?php echo GALLERY_IMAGE_SITE_A . $ctable_d['image_path']; ?>">
                                                                                    <div class="overlay-item"> <i class="fa fa-search"></i></div> <img width="370" height="425" src="<?php echo GALLERY_IMAGE_SITE_A . $ctable_d['image_path']; ?>" class="attachment-full" alt="" loading="lazy" title="shutterstock_275208287" />
                                                                                </a></div>
                                                                <?php
                                                                        }
                                                                    }
