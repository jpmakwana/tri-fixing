...
<head>
    ...
    <title>CameraRepair &#8211; Tri-fixing &#8211; Mobile Device and Electronics Repair </title>
    ...
    <link rel='shortlink' href='index5a6a.html?p=192' />
    <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embedd45b.json?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2Fcamerarepair%2F" />
    <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embedbe76?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2Fcamerarepair%2F&amp;format=xml" />
                    ...
                    <div class="container">
                        <div class="page-title-inner">
                            <div class="page-title-content clearfix"> <a href="category.php" class="back-link">Back to Services</a>
                                <h1 class="page-title ft-heading-b"><span>Camera</span>Repair</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div id="collapse-fr-service-menu9" class="collapse  " aria-labelledby="heading-9" data-parent="#fr-service-menu">
                                                                            <div class="card-body">
                                                                                <ul class="list-menu-service">
                                                                                    <li class="active"><a href="index.php"> <i class="zmdi zmdi-chevron-right"></i> <span>Camera</span>Repair </a></li>
                                                ...
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div id="cms-heading" class="cms-heading  align-left align-left-md align-left-sm align-left-xs ">
                                                            <h3 class="cms-heading-tag     " style="margin-bottom:20px;color:#083260;font-size:54px;letter-spacing:-.016em;text-transform:none;font-weight:400;font-style:normal;display:inline-block; "> Mobile Camera Repair</h3>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>Has your device&#8217;s camera stopped working?<br /> Or has it started to become grainy when taking pictures?</p>
                                                            </div>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>TekhFixers can replace your devices camera to restore it to its fully working state. Over time the camera can be susceptible to dirt build up or the small protective casing on the lens can break and leave the delicate camera exposed.</p>
                                                            </div>
                                                        </div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>More often than not, you don&#8217;t need to upgrade or replace your mobile device if the camera has lost quality! 90% of the time we can just remove and replace the glass casing and clean the internals, the other 10% of the time we simply replace the camera module.</p>
                                                            </div>
                                                        </div>
...
<!-- Mirrored from demo.cmssuperheroes.com/themeforest/wp-tekhfixers/services/camerarepair/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 06:40:37 GMT -->
