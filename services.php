...
<head>
    ...
    <title>Services &#8211; Tri-fixing &#8211; Mobile Device and Electronics Repair </title>
    ...
    <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed9391.json?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2F" />
    <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed9b97?url=https%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fwp-tekhfixers%2Fservices%2F&amp;format=xml" />
                    ...
                    <div class="container">
                        <div class="page-title-inner">
                            <div class="page-title-content clearfix">
                                <h1 class="page-title ft-heading-b">Services</h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <main id="main" class="site-main">
                                <article id="post-32" class="post-32 page type-page status-publish hentry">
                                    <div class="entry-content clearfix">
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div id="fr-service-grid" class="fr-grid fr-services-grid default  ">
                                                            <div class="filter">
                                                                <ul class="nav-gallery-filter filter-bar align-center">
                                                                    <li class="filter-item active" data-filter="*"> <span>All</span></li>
                                                                    <li class="filter-item" data-filter=".mobile-services"> <span>Mobile Services</span></li>
                                                                    <li class="filter-item" data-filter=".pc-mac-services"> <span>PC &amp; Mac Services</span></li>
                                                                    <li class="filter-item" data-filter=".smartwatch-services"> <span>Smartwatch Services</span></li>
                                                                    <li class="filter-item" data-filter=".tablet-services"> <span>Tablet Services</span></li>
                                                                </ul>
                                                            </div>
                                                            <div class="row animation-time isotope-grid">
                                                                <div class="grid-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mobile-services">
                                                                    <div class="wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                                                                        <div id="post-182" class="single-hentry-blog-post post-32 page type-page status-publish hentry"> <a href="screenrepair.php">
                                                                                <div class="entry-featured">
                                                                                    <div class="post-image" style="background: url(images/all/shutterstock_405538501.png)"></div>
                                                                                </div>
                                                                            </a>
                                                                            <div class="overlay"></div>
                                                                            <div class="entry-holder text-center">
                                                                                <div class="post-meta">
                                                                                    <h2 class="entry-title"> <span>Screen</span>Repair</h2>
                                                                                </div>
                                                                                <div class="entry-more"> <a class="read-more" href="screenrepair.php">Read More</a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="grid-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 tablet-services">
                                                                    <div class="wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                                                                        <div id="post-190" class="single-hentry-blog-post post-32 page type-page status-publish hentry"> <a href="batteryreplacement.php">
                                                                                <div class="entry-featured">
                                                                                    <div class="post-image" style="background: url(images/all/shutterstock_271948178-1.png)"></div>
                                                                                </div>
                                                                            </a>
                                                                            <div class="overlay"></div>
                                                                            <div class="entry-holder text-center">
                                                                                <div class="post-meta">
                                                                                    <h2 class="entry-title"> <span>Battery</span>Replace</h2>
                                                                                </div>
                                                                                <div class="entry-more"> <a class="read-more" href="batteryreplacement.php">Read More</a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="grid-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 tablet-services">
                                                                    <div class="wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                                                                        <div id="post-192" class="single-hentry-blog-post post-32 page type-page status-publish hentry"> <a href="camerarepair.php">
                                                                                <div class="entry-featured">
                                                                                    <div class="post-image" style="background: url(images/all/shutterstock_619717289.png)"></div>
                                                                                </div>
                                                                            </a>
                                                                            <div class="overlay"></div>
                                                                            <div class="entry-holder text-center">
                                                                                <div class="post-meta">
                                                                                    <h2 class="entry-title"> <span>Camera</span>Repair</h2>
                                                                                </div>
                                                                                <div class="entry-more"> <a class="read-more" href="camerarepair.php">Read More</a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="grid-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 smartwatch-services">
                                                                    <div class="wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                                                                        <div id="post-194" class="single-hentry-blog-post post-32 page type-page status-publish hentry"> <a href="speakerrepair.php">
                                                                                <div class="entry-featured">
                                                                                    <div class="post-image" style="background: url(images/all/shutterstock_405538558.png)"></div>
                                                                                </div>
                                                                            </a>
                                                                            <div class="overlay"></div>
                                                                            <div class="entry-holder text-center">
                                                                                <div class="post-meta">
                                                                                    <h2 class="entry-title"> <span>Speaker</span>Repair</h2>
                                                                                </div>
                                                                                <div class="entry-more"> <a class="read-more" href="speakerrepair.php">Read More</a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!-- <div class="grid-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 pc-mac-services">
                                                                    <div class="wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                                                                        <div id="post-196" class="single-hentry-blog-post post-32 page type-page status-publish hentry"> <a href="home-buttonrepair/index.html">
                                                                                <div class="entry-featured">
                                                                                    <div class="post-image" style="background: url(images/all/shutterstock_677472166.png)"></div>
                                                                                </div>
                                                                            </a>
                                                                            <div class="overlay"></div>
                                                                            <div class="entry-holder text-center">
                                                                                <div class="post-meta">
                                                                                    <h2 class="entry-title"> <span>Home Button</span>Repair</h2>
                                                                                </div>
                                                                                <div class="entry-more"> <a class="read-more" href="home-buttonrepair/index.html">Read More</a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div> -->
                                                                <div class="grid-item col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mobile-services">
                                                                    <div class="wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                                                                        <div id="post-198" class="single-hentry-blog-post post-32 page type-page status-publish hentry"> <a href="water-damagerepair.php">
                                                                                <div class="entry-featured">
                                                                                    <div class="post-image" style="background: url(images/all/shutterstock_674357041.png)"></div>
                                                                                </div>
                                                                            </a>
                                                                            <div class="overlay"></div>
                                                                            <div class="entry-holder text-center">
                                                                                <div class="post-meta">
                                                                                    <h2 class="entry-title"> <span>Water Damage</span>Repair</h2>
                                                                                </div>
                                                                                <div class="entry-more"> <a class="read-more" href="water-damagerepair.php">Read More</a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="vc_row wpb_row vc_row-fluid vc_custom_1548313055543">
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div class="fr-call-to-action default   ">
                                                            <div class="fr-cta-content">
                                                                <h3>Can’t Find a Service You’re Looking For?</h3>
                                                                <p>Get in touch for a free estimate and see how we can help</p>
                                                            </div>
                                                            <div class="fr-cta-button"> <a href="contact.php" target="_self" class="btn"> Get in Touch <i class="fa fa-angle-right"></i> </a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<!-- Mirrored from demo.cmssuperheroes.com/themeforest/wp-tekhfixers/services/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 06:40:07 GMT -->
